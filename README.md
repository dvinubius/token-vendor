...
- gone through all the challenge checkpoints
- used as a challenge to create optimal UX
- still needs improvements towards mobile-friendliness
  
## Outlook
- the transactor sometimes doesn't emit updates with the testnet deployment
- as far as I can tell it's due to Blocknative overload
- worth looking into since it breaks the UX
